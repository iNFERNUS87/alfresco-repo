...
- alfresco-repo-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- alfresco-repo-ui: main application module, development time
- alfresco-repo-production: module that produces a production mode WAR for deployment
